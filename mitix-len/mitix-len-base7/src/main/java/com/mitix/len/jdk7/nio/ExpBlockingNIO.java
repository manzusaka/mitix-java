...
public class ExpBlockingNIO {
    ...
    public void client() {
        try {
            ...
            FileChannel fileChannel = FileChannel.open(Paths.get("D:/6.rar"), StandardOpenOption.READ);
    ...
    public void server() {
        ...
        try {
            ...
            FileChannel outChannel = FileChannel.open(Paths.get("D:/7.rar"), StandardOpenOption.WRITE, StandardOpenOption.CREATE);
