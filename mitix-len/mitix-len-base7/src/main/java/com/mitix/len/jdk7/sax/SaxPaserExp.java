 ...
 * ${DESCRIPTION}
 */
public class SaxPaserExp extends DefaultHandler {
    ...
    public static void main(String[] args) throws ParserConfigurationException, SAXException, URISyntaxException, IOException {
        ...
        InputStream is = SaxPaserExp.class.getClassLoader().getResourceAsStream("sax/workers.xml");
        ...
        SaxPaserExp saxPaserTest = new SaxPaserExp();
